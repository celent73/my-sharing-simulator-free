...
export const FEATURES: Feature[] = [
    // SIMULATORS
    {
        ...
        overviewDE: 'Der Daily Chek ist das Herzstück der App. Er ermöglicht es dir, deine potenziellen Einnahmen basierend auf dem Union-Vergütungsplan mathematisch zu simulieren.',
        overviewEN: 'The Daily Chek is the heart of the app. It allows you to mathematically simulate your potential earnings based on the Union compensation plan.',
        howToIT: [
